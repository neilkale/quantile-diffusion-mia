...
# --model_path experiments/cifar10_outofdist_qmia/qr_logs/cifar10_22500/model_epoch_50.pth \
...
# --output_dir experiments/cifar10_outofdist_qmia/qr_results/cifar10_22500
...
#     python quantile_regression/eval.py \
#     --model_path experiments/cifar10_outofdist_qmia/qr_logs/cifar10_excludeclass${i}/model_epoch_50.pth \
#     --nonmember_data_path experiments/cifar10_outofdist_qmia/t_errors/cifar10/t_results_eval.pt \
#     --member_data_path experiments/cifar10_outofdist_qmia/t_errors/cifar10/t_results_train.pt \
#     --output_dir experiments/cifar10_outofdist_qmia/qr_results/cifar10_excludeclass${i}
# done

python quantile_regression/eval.py \
--model_path experiments/cifar10_outofdist_qmia/qr_logs/cifar10_on_celeba/model_epoch_50.pth \
--nonmember_data_path experiments/cifar10_outofdist_qmia/t_errors/cifar10/t_results_eval.pt \
--member_data_path experiments/cifar10_outofdist_qmia/t_errors/cifar10/t_results_train.pt \
--output_dir experiments/cifar10_outofdist_qmia/qr_results/cifar10_on_celeba
