...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channels=3, channel_reduce=1, num_classes=10, dropout_rate=0):
        ...
        self.conv1 = nn.Conv2d(in_channels, in_planes, kernel_size=3,
                               stride=1, padding=1, bias=False)
...
def ResNet34(in_channels=3, channel_reduce=1, num_classes=1, dropout_rate=0):
    return ResNet(BasicBlock, [3, 4, 6, 3], in_channels=in_channels, channel_reduce=channel_reduce, num_classes=num_classes, dropout_rate=dropout_rate)

def ResNet50(in_channels=3, channel_reduce=1, num_classes=1, dropout_rate=0):
    return ResNet(Bottleneck, [3, 4, 6, 3], in_channels=in_channels, channel_reduce=channel_reduce, num_classes=num_classes, dropout_rate=dropout_rate)
